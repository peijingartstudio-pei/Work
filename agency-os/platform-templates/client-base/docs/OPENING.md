# 開案／對齊檢查清單（請連回 SSOT，勿只填本頁）

> 本檔在 **`platform-templates/client-base`**：**輔助**用。長期維運與稽核仍靠 **`tenants/`** + 龍蝦閘道。

## 本專案一頁紙（可給內部或客戶預覽）

- 客戶／品牌：
- 專案代號（若已有 `tenants/company-*` / site / project，寫路徑）：
- 目標（一句話預覽）：
- Staging URL：
- Production URL（若已知）：
...
## 紀錄用（in/out／風險仍建議進 WORKLOG／Discovery）
